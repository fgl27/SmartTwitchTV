...
function DefaultLang() {
    ...
    STR_FOR_THIS = STR_SPACE + STR_FOR_THIS;
    ...
    STR_USER_HOSTING = STR_SPACE + STR_USER_HOSTING;
    STR_USER_SET = STR_SPACE + STR_USER_SET;
    STR_JUMP_T0 = STR_SPACE + STR_JUMP_T0;
    ...
    STR_LATEST_VERSION = STR_SPACE + STR_LATEST_VERSION;
    STR_CONTROLS_MAIN_6 = STR_SPACE + STR_CONTROLS_MAIN_6;
    STR_OAUTH_WRONG2 = STR_SPACE + STR_OAUTH_WRONG2;
    ...
    STR_BACK_USER_GAMES = STR_SPACE + STR_BACK_USER_GAMES;
    ...
    STR_AVG = STR_SPACE + STR_AVG;
    STR_OFFSET = STR_SPACE + STR_OFFSET;
