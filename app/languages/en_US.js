function en_USLang() {
    ...
    STR_CHANNEL = "Channel";
    STR_GOBACK = "Back to previously screen (backspace)";
    ...
    STR_CLOSE_THIS = "Press backspace key to close this.";
    ...
    STR_CONTROLS_MAIN_3 = "Refresh screen content: Home";
    STR_CONTROLS_MAIN_4 = "Close the application: from Live screen press backspace to see the options";
    ...
    STR_CONTROLS_MAIN_11 = "After setting up the search text press backspace or click on DONE and use the Directional pad (left/right) to chose the type of search then press Select or Play/Pause, Directional pad (up) goes back to edit the search text";
    ...
    STR_CONTROLS_PLAY_2 = "Close the video: press backspace (click it twice under 3 seconds, click tree times if information panel or controls is open)";
    ...
    STR_CONTROLS_PLAY_7 = "Show or hide the Chat (over the video): Home";
    ...
    STR_STARTED = "Started ";
    STR_KEY_UP_DOWN = " (Page Up/Dn)";
    STR_VIDEOS = "Videos";
    STR_VIDEO = " Video";
    STR_REPLAY = "Replay";
    STR_STREAM_END = "exiting in ";
    STR_STREAM_END_EXIT = 'press "backspace" to exit';
