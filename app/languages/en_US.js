...
function en_USLang() {
    ...
    STR_OAUTH_IN = 'Adding a key allows the app to access chat using yours user to send messages and get yours emote list (enable you to get gift sub given to chat), follow/unfollow channels/games and access some user content faster<br><br>Add a key is not demanding and can be done at any point later<br><br>In doubt read this link<br><br>https://github.com/fgl27/SmartTwitchTV#authorization<br><br>For some devices is necessary a mouse to complete the authorization action as you may need to clock on a button to confirm.<br><br>add key for';
