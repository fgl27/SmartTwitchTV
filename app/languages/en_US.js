...
function en_USLang() {
    ...
    STR_SHOW_LIVE_PLAYER = 'Show Live streams preview';
    STR_SHOW_VOD_PLAYER_WARNING = 'Starting playback from where it last stop:';
    STR_SHOW_VOD_PLAYER = 'Show VOD preview';
    STR_SHOW_CLIP_PLAYER = 'Show CLIP preview';
    STR_PREVIEW_CLIP_NEXT = 'When a clip preview end automatic switch next available clip';
    STR_SHOW_SIDE_PLAYER = 'Show side panel preview';
    STR_SHOW_FEED_PLAYER = 'Show preview over the player preview thumbnails';
