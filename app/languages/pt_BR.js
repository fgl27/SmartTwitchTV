...
function pt_BRLang() {
    ...
    STR_OPEN_BROADCAST = "Abra o video";
    ...
    STR_CHAT_SEND_DELAY = "Envio de mensagem, atraso de chat habilitado, a mensagem será exibida no chat após";
    ...
    STR_CHAT_DISABLE = "chat está desabilitado à força, habilite-o nos controles da parte inferior do jogador chat forçado desabilitado";
    ...
    STR_PICTURE_CONTROLS8 = "Reiniciar jogador: use os controles inferiores do jogador Reiniciar jogador, isso só irá reiniciar todos os jogadores, útil para sincronizar jogador e chat, isso não irá sincronizar o conteúdo de um jogador com outro";
    ...
    STR_CHAT_FOLLOWER_ONLY = "chat é o modo apenas para seguidores e você não é um seguidor de";
    STR_CHAT_FOLLOWER_ONLY = "chat é o modo apenas para seguidores e você não é um seguidor de";
    ...
    STR_SHOW_IN_CHAT_SUMMARY = "Isso é muito útil para saber, por exemplo, se o chat offline tem algum usuário com quem conversar, também deixe o usuário saber a diferença entre o visualizador total e o usuário total do chat";
