...
function pt_BRLang() {
    ...
    STR_KEY_MEDIA_FF = "ou tecla de retrocesso de mídia de avanço rápido";
    STR_GUIDE_EXTRA = STR_SPACE + "ou pressione a tecla 2";
    STR_GUIDE_EXTRA2 = "ou chave de mídia próxima faixa";
    ...
    STR_SWITCH = "Alternar tela";
    STR_SWITCH_USER = "Alternar tela de usuário";
    STR_SWITCH_VOD = "Alternar: Videos ou Destaques";
    STR_SWITCH_CLIP = "Switch: Período (24h, 7d, 30d, todos)";
    ...
    STR_PLACEHOLDER_PRESS = "Pressione Enter ou a tecla Selecionar para,";
    STR_CHANNELS = "Canais";
    STR_CHANNEL = "Canal";
    ...
    STR_VIEWS = "Vistas";
    STR_VIEWER = "Visualizadores";
    STR_EXIT_AGAIN = "Clique novamente para sair!";
    STR_EXIT_AGAIN_PICTURE = "Clique novamente para sair de Picture in Picture!";
    STR_EXIT_AGAIN_MULTI = "Clique novamente para sair do MultiStream!";
    STR_EXIT_MESSAGE = "Deseja sair do SmartTV Client para Twitch?";
    STR_EXIT = "Sair";
    STR_CHANGELOG = "Changelog";
    STR_FULL_CHANGELOG = " Log de alterações completo";
    STR_CHANGELOG_SUMMARY = "Estas são apenas as alterações mais recentes, para ler as alterações completas verifique o link abaixo:";
    ...
    STR_WEB_UPDATE_AVAILABLE = "Web Atualização disponível";
    ...
    STR_ADD_USER_SH = "Adicionar um usuário Twitch para exibir o conteúdo dos Canais Seguidos aqui";
    STR_CLIP_DAY = "24h";
    STR_CLIP_WEEK = "7d";
    STR_CLIP_MONTH = "30d";
    STR_CLIP_ALL = "todos";
    ...
    STR_CLOSE_THIS = "Pressione Enter ou Enter para fechar isto.";
    STR_CLOSE_THIS2 = "Pressione voltar para fechar isso.";
    STR_CLOSE_THIS3 = "Pressione voltar para mostrar a caixa de diálogo de atualização ou Enter para fechá-la.";
    STR_PLAYER = "Relacionado ao jogador:";
    STR_CHAT = "Relacionado ao bate-papo:";
    STR_CHAT_SHOW = "Mostrar bate-papo";
    ...
    STR_ABOUT_INFO_19 = "Sim, é possível usar este aplicativo em telefones e tablets, mas este aplicativo foi projetado para ser usado principalmente em TVs, o suporte para outros dispositivos é limitado e por isso não lançado na play store, use o link abaixo para fazer o download APK mais recente e instale manualmente em um telefone ou tablets ";
    ...
    STR_ABOUT_INFO_22 = "Bandeja: uma substituição de SharedPreferences para Android (https://github.com/grandcentrix/tray)";
    ...
    STR_CONTROLS_PLAY_0 = STR_SPACE + "ou nos controles da parte inferior do player";
    STR_CONTROLS_PLAY_1 = "Mostrar painel de informações: Pressione a tecla Enter ou D-pad se o chat e o feed do canal ao vivo não estiverem sendo exibidos";
    ...
    STR_CONTROLS_PLAY_8 = "Alterar posição de bate-papo: D-pad para a esquerda, PG para cima ou retroceder (apenas VOD e clipes)" + STR_CONTROLS_PLAY_0;
    STR_CONTROLS_PLAY_9 = "Alterar tamanho do bate-papo: D-pad para a direita ou PG para baixo" + STR_CONTROLS_PLAY_0;
    STR_CONTROLS_PLAY_10 = "Alterar brilho de fundo do bate-papo: alterar os controles da parte inferior do player";
    STR_CONTROLS_PLAY_11 = "Forçar atualização do bate-papo nas transmissões ao vivo (caso ele congele ou não carregue): use os controles da parte inferior do player para desativar o bate-papo (clique duas vezes)";
    ...
    STR_CONTROLS_PLAY_14 = "Bate-papo e vídeo (lado a lado): tecla 2 ou tecla de mídia avanço rápido, também alterna entre imagem em imagem e modo 50/50";
    STR_F_DISABLE_CHAT = "Chat forçado desabilitado";
    STR_OAUTH_IN = 'Adicionar uma chave permite que o aplicativo acesse o bate-papo usando seu usuário para enviar mensagens e obter sua lista de emoticons (permite que você receba subdotados para bate-papo), seguir / parar de seguir canais / jogos e acessar algum conteúdo do usuário mais rápido <br> <br> Adicionar uma chave não é exigente e pode ser feito a qualquer momento mais tarde <br> <br> Em caso de dúvida, leia este link: <br> <br> https://github.com/fgl27/SmartTwitchTV#authorization<br > <br> Para alguns dispositivos é necessário um mouse para concluir a ação de autorização, pois pode ser necessário clicar manualmente em um botão para confirmar. <br> <br> adicionar chave para ';
    ...
    STR_FOLLOW = "Seguir";
    STR_IS_SUB_NOOAUTH = "E você não adicionou uma chave de autorização, o aplicativo não pode verificar o seu sub status.";
    ...
    STR_IS_LIVE = "Agora está ativo ";
    STR_SHOW_ISLIVE_WARNING = 'Mostrar "Streamer' + STR_IS_LIVE + '" Aviso';
    ...
    STR_STAY_OPEN = "Permanecer na transmissão";
    STR_STAY_OPEN_SUMMARY = "Fique ligado e verifique novamente para ver se volta ao vivo";
    STR_STAY_CHECK = "Verifique se a transmissão está ao vivo em:";
    ...
    STR_NO_BROADCAST_WARNING = "Não há video para este clipe";
    STR_NO_CHAT = "E por causa disso nenhum chat";
    STR_IS_NOW = "agora é";
    STR_OPEN_HOST = "Abra o Hosting";
    STR_SETTINGS_PLAYER = "Jogador relacionado";
    STR_SETTINGS_BUFFER_SIZE = "Iniciar tamanho do Buffer:";
    STR_SETTINGS_BUFFER_SIZE_SUMMARY = "Quanto é necessário armazenar em buffer antes de iniciar a reprodução, isso não está relacionado ao tamanho máximo que o buffer pode atingir (o tamanho máximo do buffer é baseado no tamanho da RAM do dispositivo), um valor menor aqui fará com que a reprodução comece mais cedo e isso é sempre recomendado. Alterar este valor para um valor maior na maioria dos casos não causará nenhuma melhora, mas sim retrocessos ";
    STR_SETTINGS_BUFFER_LIVE = "Buffer de início de streams ao vivo";
    STR_SETTINGS_BUFFER_VOD = "Vídeos (video e destaque) Iniciar buffer";
    STR_SETTINGS_BUFFER_CLIP = "Clip iniciar buffer";
    STR_SETTINGS_LANG = "Idioma";
    STR_LOADING_CHAT = "Chat: Conectando a";
    STR_LOADING_FAIL = "Tempo limite de conexão, falha ao registrar ...";
    STR_CHAT_CONNECTED = "Chat: Conectado";
    STR_CHAT_SEND_DELAY = "Envio de mensagem, atraso de bate-papo habilitado, a mensagem será exibida no bate-papo após";
    STR_CHAT_DELAY = "Chat: atraso";
    STR_VOD_HISTORY_BASE = "Jogue desde o início ou de onde parou de assistir";
    ...
    STR_CHAT_END = "Bate-papo: O bate-papo terminou!";
    ...
    STR_SWITCH_TYPE = "Alternar: Recente ou visualização";
    STR_ENABLE = "Ativar";
    STR_ENABLED = "Ativado";
    STR_DISABLE = "Desativar";
    STR_DISABLED = "Desativado";
    STR_DARK_MODE = "Modo escuro";
    STR_BRIGHT_MODE = "Modo brilhante";
    ...
    STR_RESTORE_PLAYBACK_SUMMARY = "O aplicativo salva o que estava tocando no caso de fechar acidentalmente, alterando os aplicativos, o sistema pode ficar sem memória e fechá-lo ou forçar o fechamento pelo usuário nesses casos, o aplicativo irá restaurar o que estava reproduzindo na próxima inicialização";
    STR_CHAT_FONT = "Tamanho da fonte do bate-papo";
    STR_VIDEOS_ANIMATION = "Miniaturas animadas do vídeo";
    STR_VIDEOS_ANIMATION_SUMMARY = "Quando um VOD ou Realce é selecionado animar a miniatura se uma miniatura animada estiver disponível para aquele vídeo (nem todos os vídeos têm uma)";
    STR_SIDE_PANEL = "Painel lateral: D-pad para a esquerda ou tecla de retorno";
    STR_SIZE = "Tamanho";
    STR_BRIGHTNESS = "Brilho";
    STR_FORBIDDEN = "Conteúdo proibido, é restrito à sua região ou restrito ao aplicativo Twitch oficial";
    ...
    STR_CLOCK_OFFSET_SUMMARY = "Ajuste o relógio do aplicativo principal em relação à sua escolha";
    STR_APP_LANG = "Idioma do aplicativo";
    STR_CONTENT_LANG = "Idioma do conteúdo";
    STR_CONTENT_LANG_SUMMARY = "Pressione Enter para acessar";
    STR_LANG_ALL = "Todos";
    STR_NO_GAME = "Nenhum jogo deste";
    STR_EMPTY = "vazio";
    STR_JUMP_BUFFER_WARNING = "Não é possível saltar durante o buffer";
    STR_CHAT_DISABLE = "Bate-papo está desabilitado à força, habilite-o nos controles da parte inferior do jogador Bate-papo forçado desabilitado";
    STR_CLIP_FAIL = "Este clipe / vídeo falhou ao carregar. Não é possível reproduzir";
    STR_CHAT_BRIGHTNESS = "Brilho de fundo do bate-papo";
    STR_PLAY_NEXT = "Reproduzir a seguir";
    STR_PLAY_NEXT_IN = "Jogando a seguir em";
    ...
    STR_END_DIALOG_OPT = "Opções de final de diálogo do jogador";
    STR_END_DIALOG_SETTINGS = "Tempo limite da caixa de diálogo de finalização do jogador";
    STR_END_DIALOG_SETTINGS_SUMMARY = "Quando um Live / VOC / Clip termina uma caixa de diálogo mostra a opção do que fazer a seguir, defina o tempo (em segundos) que levará para a opção padrão agir";
    STR_END_DIALOG_DISABLE = "Desativar o cronômetro";
    STR_CHAT_SIZE = "Tamanho do bate-papo";
    STR_CHAT_POS = "Posição de bate-papo";
    STR_CHAT_VIDEO_MODE = "Modo de vídeo";
    STR_CHAT_SIDE_FULL = "Tela inteira";
    STR_CHAT_PP_SIDE_FULL = "Tela grande e pequena";
    STR_CHAT_SIDE = "Lado a lado, vídeo e bate-papo";
    ...
    STR_BITCOIN_SUMMARY = "Doações de Bitcoin usam endereço de carteira:";
    STR_PLAYER_PROBLEM_2 = "A conexão falhou, não foi possível carregar as informações do fluxo";
    STR_PLAYER_RESYNC = "Reiniciar jogador";
    ...
    STR_PLAYER_MAIN = "Jogador principal, para o jogador grande em imagem na imagem ou o jogador principal 50/50";
    ...
    STR_VOLUME = "Volume -";
    STR_AUDIO = "Áudio -";
    STR_DEF_QUALITY = "Qualidade padrão do jogador";
    STR_DEF_QUALITY_SUMMARY = 'Esta opção será sempre honrada ao reproduzir um único vídeo, no modo Imagem Imagem ou Multistream a reprodução precisa usar a qualidade Auto, pelo motivo é que, marque a opção de configurações "' + STR_PLAYER_BITRATE + '"';
    STR_PICTURE_PICTURE = "Imagem sobre imagem, 50/50 ou Multistream (apenas para transmissões ao vivo):";
    STR_PICTURE_CONTROLS1 = "Habilitar modo Picture in Picture: Reproduzindo um vídeo, pressione para cima para mostrar o feed de visualização, escolha um fluxo e segure a tecla Enter ou pressione a tecla 1 para iniciar";
    STR_PICTURE_CONTROLS2 = "Alterar um conteúdo de vídeo: a partir da visualização do player, se estiver no modo multijogador, clique sempre uma vez, Se em PP ou 50/50 um único clique atualizar o vídeo grande ou superior, segure a tecla Enter ou pressione a tecla 1 para atualizar o vídeo pequeno ou inferior";
    ...
    STR_PICTURE_CONTROLS5 = "Alterar a posição do vídeo pequeno (somente imagem na imagem): D-pad para a esquerda";
    STR_PICTURE_CONTROLS6 = "Alterar tamanho pequeno do vídeo (somente imagem na imagem): D-pad à direita";
    ...
    STR_PICTURE_CONTROLS8 = "Reiniciar jogador: use os controles inferiores do jogador Reiniciar jogador, isso só irá reiniciar todos os jogadores, útil para sincronizar jogador e bate-papo, isso não irá sincronizar o conteúdo de um jogador com outro";
    STR_PICTURE_CONTROLS9 = "Sincronizar jogadores manualmente: É uma solução alternativa usar o controle inferior do reprodutor Velocidade para desacelerar o fluxo que está na frente ou vice-versa só funciona no modo PP";
    ...
    STR_PICTURE_CONTROLS11 = "Fechar vídeo pequeno ou inferior (somente imagem na imagem): a tecla voltar duas vezes para sair do modo PP ou 50/50";
    STR_PICTURE_CONTROLS12 = "Habilitar modo 50/50 (dois stream dois chats): Se imagem em imagem habilitar, pressione a tecla 2 ou a tecla de mídia para avançar ou use os controles inferiores 'Modo de Vídeo' ou se já estiver no modo 'lado a lado', mantenha a tecla bloco do feed de visualização ";
    STR_PICTURE_CONTROLS13 = "Ativar Multistream: use os controles da parte inferior do player ou a tecla de retrocesso de mídia";
    STR_PLAYER_INFO_VISIBILITY_ARRAY = ["Quando as informações do jogador estão visíveis", "Sempre visível", "Nunca visível"];
    STR_SINGLE_EXIT = "Pressione a tecla de retorno único";
    STR_SINGLE_EXIT_SUMMARY = "Saia do player, imagem em imagem, modo 50/50 ou Multistream com um único clique de retorno da tecla";
    ...
    STR_ROUND_IMAGES = "Imagens de canais arredondados";
    STR_ROUND_IMAGES_SUMMARY = "Como a maioria das imagens do canal são quadrados, algumas imagens podem não parecer OK";
    STR_SCREEN_COUNTER = "Ocultar posição / contador total";
    STR_SCREEN_COUNTER_SUMMARY = "Existe um contador de posição que informa a posição atual e o conteúdo total carregado nas telas que possuem conteúdo reproduzível, conforme você rola mais conteúdo será carregado e o total será atualizado";
    STR_SWITCH_POS = "Alterar: Deslocar posição inicial";
    ...
    STR_LOW_LATENCY = "Baixa Latência";
    ...
    STR_LIVE_FEED_SORT = "Painel lateral ou classificação da visualização do player";
    STR_LIVE_FEED_SORT_SUMMARY = "Classifica o feed ao vivo do painel lateral e a visualização do player, na visualização isso se aplica apenas ao usuário ao vivo e em destaque (todos os históricos sem base de visualizações, o histórico é assistido pela última vez primeiro e o vod é o mais recente)";
    STR_A_Z = "Alfabético A - Z";
    STR_Z_A = "Alfabético Z - A";
    STR_APP_ANIMATIONS = "Ativar animações de aplicativos";
    STR_APP_ANIMATIONS_SUMMARY = "Controla o painel lateral, rolagem, notificação e animações relacionadas";
    ...
    STR_DPAD_OPACITY = "opacidade do D-pad";
    ...
    STR_USER_LIVE = "Painel lateral do usuário Live: do painel lateral direcional esquerdo ou de qualquer lugar, pressione 3";
    STR_PP_WORKAROUND = " Solução alternativa do antigo SO no modo multijogador";
    STR_PP_WORKAROUND_SUMMARY = "Para alguns dispositivos rodando Android 7 (Nougat) ou mais antigo é necessário habilitar isto para que o modo Multijogador funcione corretamente, não habilite isto se você não tiver problemas, pois resultará em uma qualidade de imagem inferior e possível perda de desempenho ";
    STR_HISTORY = "História";
    ...
    STR_VIWES_MOST = "Visualizações mais altas";
    STR_VIWES_LOWEST = "Visualizações mais baixas";
    ...
    STR_CREATED_NEWEST = "Criado / Uptime mais recente";
    STR_CREATED_OLDEST = "Criado / Tempo de atividade mais antigo";
    STR_THUMB_OPTIONS = "Opções de miniatura";
    STR_HISTORY_LIVE_DIS = "Habilitar histórico ao vivo";
    STR_HISTORY_VOD_DIS = "Habilitar histórico de VOD";
    ...
    STR_DELETE_FROM_HISTORY = "Excluir isto do histórico";
    STR_CHECK_HISTORY = "Verificando status de acompanhamento ...";
    ...
    STR_REPLACE_MULTI_ENTER = "Pressione Enter para substituir ou retornar para sair sem.";
    STR_ALREDY_PLAYING = "Já está jogando";
    STR_STREAM_ERROR = "Não foi possível abrir a visualização";
    STR_PP_MODO = "Modo imagem em imagem";
    ...
    STR_CONTROLS_MULTI_1 = 'Se você está tendo problemas de atraso após habilitar o multistream, tente diminuir o valor de "Taxa de bits do jogador pequeno" nas configurações, o acúmulo de quadros pulados ou buffer constante é uma indicação de taxa de bits muito alta ou Internet lenta';
    STR_CONTROLS_MULTI_2 = "Adicionar streams: abra a chave do feed de visualização e clique em um stream ao vivo";
    STR_CONTROLS_MULTI_3 = "Substituir streams: depois que o multistream estiver cheio, escolha um no feed de visualização e escolha um para substituir na caixa de diálogo";
    ...
    STR_CONTROLS_MULTI_5 = "Sair do multistream: do controle inferior do jogador ou tecla de retorno duas vezes";
    STR_CONTROLS_MULTI_6 = "Para fechar este abrir 4 transmissões ao vivo";
    STR_PICTURE_LIVE_FEED = 'Imagem na imagem: Segure enter ou pressione 1, após usar o D-Pad para a esquerda para mover, para a direita para redimensionar ou para baixo para mudar os vídeos';
    STR_MULTI_TITLE = ", Clique em uma miniatura para abrir ou substituir um fluxo, use o direcional esquerdo / direito para mudar a fonte de áudio";
    STR_FEED_END_DIALOG = ', Pressione voltar para voltar ao menu superior';
    ...
    STR_SHOW_VOD_PLAYER = 'Mostrar previsão nas telas VOD';
    STR_SHOW_CLIP_PLAYER = 'Mostrar previsão nas telas CLIP';
    STR_PREVIEW_CLIP_NEXT = 'Quando a visualização de um clipe termina, troca automática do próximo clipe disponível';
    STR_SHOW_SIDE_PLAYER = 'Mostrar previsão no painel lateral';
    STR_SHOW_FEED_PLAYER = 'Mostrar antevisão nas miniaturas de antevisão do leitor';
    STR_SHOW_FEED_PLAYER_SUMMARY = "Se você não quiser ou seu dispositivo ficar atrasado quando mais de um jogador estiver ativo, defina como NÃO";
    STR_DISABLED_FEED_PLAYER_MULTI = 'Desativar visualização quando multistream está ativado';
    STR_DISABLED_FEED_PLAYER_MULTI_SUMMARY = 'Por motivos de desempenho, alguns dispositivos podem atrasar com vários jogadores, se você estiver OK para multistream, mas quando o player de pré-visualização e multistream estão ativos, os lags do dispositivo configuram para NÃO';
    STR_PREVIEW_ERROR_LOAD = "A pré-visualização falhou ao carregar:";
    STR_PREVIEW_ERROR_LINK = "inacessível";
    STR_PREVIEW_VOD_DELETED = ", este VOD pode ter sido excluído";
    STR_PREVIEW_END = "A pré-visualização do vídeo terminou";
    STR_PLAYER_LAG_ERRO = "Jogador incapaz de jogar devido a um problema de conexão de rede";
    STR_PLAYER_ERROR = "Jogador incapaz de jogar, devido ao erro do jogador";
    STR_PLAYER_ERROR_MULTI = ", tente diminuir o valor da taxa de bits do jogador nas configurações";
    ...
    STR_PREVIEW_SIZE_SCREEN = "Tamanho da visualização das telas";
    STR_PREVIEW_SIZE_SCREEN_SUMMARY = "Definir o tamanho da visualização";
    STR_PREVIEW_SIZE_SCREEN_ARRAY = ["Tamanho da miniatura", "Maior"];
    STR_SIDE_PANEL_PLAYER_DELAY = "Atraso na visualização";
    STR_SIDE_PANEL_PLAYER_DELAY_SUMMARY = "Defina o tempo de atraso que a visualização levará para começar a carregar depois que uma miniatura for selecionada, isso ajuda com dispositivos lentos que atrasam ao rolar";
    STR_PREVIEW_VOLUME = "Volume de visualização";
    STR_PREVIEW_VOLUME_SUMMARY = "Permitir definir qual será o volume de visualização do feed";
    STR_PREVIEW_OTHERS_VOLUME = "Volume dos jogadores principais";
    STR_PREVIEW_OTHERS_VOLUME_SUMMARY = "O volume do player principal (todos os jogadores picture in picture, players multistream) pode ser menor quando o player de pré-visualização é exibido";
    STR_SIDE_PANEL_PLAYER = "Pré-visualizar configurações de jogadores em miniatura";
    STR_START_AT_USER = "Sempre inicie o aplicativo na tela do usuário";
    STR_START_AT_USER_SUMMARY = "Isso impedirá o trabalho de Restaurar a reprodução, mas permite escolher o usuário ao iniciar o aplicativo";
    STR_LAST_REFRESH = "última atualização:";
    STR_PP_VOD_ERROR = "Saia do PP ou Multistream para abrir este VOD";
    STR_SETTINGS_ACCESSIBILITY = 'Mostrar "um serviço de acessibilidade está em execução aviso"';
    STR_SETTINGS_ACCESSIBILITY_SUMMARY = "Se o dispositivo tiver um serviço de acessibilidade habilitado, o aplicativo mostrará um aviso, é um problema conhecido do Android que o serviço de acessibilidade pode atrasar alguns dispositivos e causar congelamentos ou atrasos neste aplicativo.";
    STR_ACCESSIBILITY_WARN = "Serviço (s) de acessibilidade detectado (s)";
    STR_ACCESSIBILITY_WARN_EXTRA = "Leia mais sobre neste link:";
    STR_ACCESSIBILITY_WARN_EXTRA2 = "Se você tiver travamentos ou problemas relacionados ao lag, feche este aplicativo e desabilite todos os serviços de acessibilidade depois que todos os problemas forem resolvidos. <br> Para não mostrar este aviso nunca mais desabilite-o nas configurações";
    ...
    STR_CHAT_BANNED = "Você está permanentemente proibido de falar em";
    STR_CHAT_WRITE = "Escreva no chat";
    STR_CHAT_EXTRA = "Configurações extras de bate-papo";
    ...
    STR_CHAT_ROOMSTATE = "Bate-papo ROOMSTATE:";
    ...
    STR_CHAT_BTTV_STREAM = "streamer BTTV";
    STR_CHAT_FFZ_GLOBAL = "FFZ global";
    STR_CHAT_FFZ_STREAM = "streamer FFZ";
    STR_CHAT_AT_STREAM = "@streamer";
    STR_CHAT_RESULT = "Resultado esperado no bate-papo:";
    STR_CHAT_SEND = "Enviar";
    STR_CHAT_EMOTE_EMPTY = "Esta lista de emote está vazia";
    STR_CHAT_FOLLOWER_ONLY = "Bate-papo é o modo apenas para seguidores e você não é um seguidor de";
    STR_CHAT_FOLLOWER_ONLY = "Bate-papo é o modo apenas para seguidores e você não é um seguidor de";
    STR_CHAT_FOLLOWER_ONLY_USER_TIME = "e você só está seguindo para";
    STR_CHAT_EMOTE_ONLY = "Modo Twitch apenas emote ";
    STR_CHAT_CHOOSE = "Escolha com chat para escrever ou pressione voltar para fechar";
    STR_CHAT_OPTIONS_TITLE = "Escreva nas opções de chat";
    STR_CHAT_OPTIONS_KEYBOARD = "Auto ocultar teclado de software";
    STR_CHAT_OPTIONS_KEYBOARD_SUMMARY = "Permite controlar o comportamento do teclado do software na tela, se você tiver um teclado físico conectado use-o, se não estiver configurado para nunca";
    STR_CHAT_OPTIONS_KEYBOARD_1 = "Nunca";
    STR_CHAT_OPTIONS_KEYBOARD_2 = "Se teclado detectado";
    STR_CHAT_OPTIONS_KEYBOARD_3 = "Sempre";
    STR_CHAT_OPTIONS_EMOTE_SORT = " Seleção de emoções ";
    STR_CHAT_OPTIONS_EMOTE_SORT_SUMMARY = "Se estiver desabilitado, as listas de emotes serão mostradas no provedor de pedidos pelo servidor";
    STR_CHAT_OPTIONS_FORCE_SHOW = "Forçar mostrar chat";
    STR_CHAT_OPTIONS_FORCE_SHOW_SUMMARY = "Se você deseja ver o chat quando escrever para chat for usado, habilite isto";
    // STR_WARNING_NEW = "Um novo destaque foi adicionado <br> <br> Escreva no bate-papo <br> <br> Porque este novo destaque todas as chaves de autorização adicionadas anteriormente foram revogadas, porque as permissões de bate-papo não foram solicitadas antes <br> < br> Se você adicionou uma chave, adicione uma nova para que possa continuar usando o aplicativo da mesma forma que antes <br> <br> Se você tiver alguma dúvida sobre a nova chave de autorização, vá para: <br> <br> https://github.com/fgl27/SmartTwitchTV#authorization <br> <br> Esta caixa de diálogo será ocultada automaticamente em 1 minuto ";
    STR_NOKEY_CHAT_WARN = "Adicionar uma chave de autorização do usuário para poder acessar e escrever no chat";
    STR_CHAT_NOT_READY = "Bate-papo não está pronto para enviar! Tente novamente em um ou dois segundos.";
    STR_CHAT_REDEEMED_MESSAGE_HIGH = " Resgatado Destacar Minha Mensagem";
    STR_CHAT_REDEEMED_MESSAGE_SUB = " Resgatado Enviar uma Mensagem no Modo Sub-Only";
    STR_CHAT_OPTIONS = "Opções de bate-papo";
    STR_CHAT_HIGHLIGHT_REDEEMED = "Destacar mensagens de recompensas (somente mensagem de fundo roxo)";
    ...
    STR_CHAT_HIGHLIGHT_BIT = "Mensagem dos bits de destaque (fundo amarelo escuro)";
    ...
    STR_CHAT_INDIVIDUAL_BACKGROUND_SUMMARY = "Os modos são desabilitar, habilitar (modo automático), claro ou mais escuro, no modo automático se o chat estiver acima do stream, a mensagem estranha terá uma cor de destaque de fundo mais escura do par, se o chat não estiver acima (lado a lado, por exemplo) a cor ficará brilhante ";
    ...
    STR_CHAT_LOGGING_SUMMARY = "O aplicativo sempre fará login no bate-papo usando o usuário atual quando uma chave de autorização for fornecida, a menos que o bate-papo seja desabilitado nos controles da parte inferior do jogador, mas se esta opção for definida como NÃO, impedirá o login usando o nome de usuário atual e, em vez disso, será registrado como anônimo , mesmo que forneça uma chave de autorização. Isso não impede o envio de mensagem de chat para este usuário se uma chave for adicionada, mas impede o formulário de saber se você está banido do chat e impede o conhecimento do chat ROOMSTATE ";
    STR_CHAT_TIMESTAMP = "Mostrar data e hora da mensagem";
    STR_CHAT_NICK_COLOR = "Cores de nick legíveis";
    STR_CHAT_NICK_COLOR_SUMMARY = "Em vez de usar a cor padrão do nick que algumas vezes não pode ser lida em um fundo escuro, use uma cor personalizada fácil de ler";
    ...
    STR_CHAT_CLEAR_MSG_SUMMARY = 'Excluir mensagens de bate-papo de um usuário específico (normalmente após receberem um tempo limite ou banimento), as mensagens excluídas sempre terão um fundo azul, a mensagem será excluída se estiver definido como sim, se não apenas a cor de fundo irá mudar ';
    ...
    STR_PING_WARNING_SUMMARY = "O aplicativo está constantemente verificando a conexão com o Twitch por meio de um ping, se isso falhar muito, um aviso será exibido, se esse aviso estiver mostrando involuntariamente, defina como NÃO";
    STR_KEY_UP_TIMEOUT = "Tempo limite de retenção da chave (em milissegundos)";
    STR_KEY_UP_TIMEOUT_SUMMARY = "Quanto tempo você precisa para segurar uma tecla para que uma ação de espera aconteça, as ações são atualizadas uma tela, mostra opções de miniaturas etc.";
    STR_CURRENT_THUMB_STYLE = "Estilo de foco atual";
    STR_NEW_THUMB_STYLE = "Novo estilo de foco";
    STR_COLOR_STYLE_TEXT = 'Pressione para cima / baixo para selecionar uma opção, pressione Enter para sair, pressione Enter em "Aplicar alterações" para confirmar antes de sair.';
    STR_SHADOWS = "Sombras";
    ...
    STR_VOD_SEEK = "VOD controles de retrocesso / avanço rápido";
    STR_VOD_SEEK_SUMMARY = "Controla a velocidade de retrocesso / avanço dos passos, ao clicar e segurar para a esquerda / direita o tempo do passo aumentará depois que o tempo limite de aumento passar, ele aumentará até o tempo máximo do passo, após soltar a tecla e não clicar em um segundo, o tempo da etapa será redefinido para o tempo mínimo da etapa. <br> <br> Pressionar irá sobrescrever o valor mim / max, permitindo que você passe por todas as etapas possíveis e bloqueará o valor até que a barra de progresso seja descartada <br > <br> Fazer cliques únicos sem segurar a tecla não aumentará o tempo <br> <br> Esta opção só funciona em VODs para Clip o passo é sempre de 1 segundo ";
    STR_VOD_SEEK_MIN = "Tempo mínimo (inicial) da etapa";
    STR_VOD_SEEK_MAX = "Tempo máximo da etapa";
    ...
    STR_IN_CHAT = "No chat";
    STR_SHOW_IN_CHAT = "Mostrar total de usuários logados no chat ou visualizadores";
    STR_SHOW_IN_CHAT_SUMMARY = "Isso é muito útil para saber, por exemplo, se o bate-papo offline tem algum usuário com quem conversar, também deixe o usuário saber a diferença entre o visualizador total e o usuário total do bate-papo";
    STR_SHOW_IN_CHAT_VIEWERS = 'Mostrar visualizadores';
    STR_SHOW_IN_CHAT_CHATTERS = 'Mostrar chatters';
    STR_PLAYED = "Jogado";
    STR_CHAPTERS = "Capítulos";
    STR_FROM_SIMPLE = "de";
    STR_HIDE_MAIN_CLOCK = "Ocultar relógio da tela principal";
    STR_HIDE_PLAYER_CLOCK = "Ocultar relógio do jogador";
    STR_HIDE_MAIN_SCREEN_TITLE = "Ocultar título da tela principal";
    STR_HIDE_MAIN_SCREEN_TITLE_SUMMARY = "O título central, Live, Clip, Configurações etc ...";
    ...
    STR_INACTIVE_SETTINGS = "Minimizar automaticamente o aplicativo quando inativo para";
    STR_INACTIVE_SETTINGS_SUMMARY = "Impedir que o aplicativo seja executado quando ninguém estiver usando, um aviso aparecerá dando ao usuário 15 segundos para pressionar qualquer tecla para evitar a minimização";
    ...
    STR_PLAYER_INFO_VISIBILITY = "Visibilidade do status do jogador";
    STR_PREVIEW_SET = "Configurações de visualização";
    STR_PREVIEW_SHOW = "Mostrar visualização";
    STR_PREVIEW_SIZE_CONTROLS = "Tamanho da visualização";
    STR_OLED_BURN_IN = "OLED Burn em proteção";
    STR_OLED_BURN_IN_SUMMARY = "Quando ativado, a tela ficará totalmente preta por 50 ms em 20 minutos, apenas necessário para dispositivos com telas OLED que apresentam problemas de burn-ins";
    STR_AS = "como";
