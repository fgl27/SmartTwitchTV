...
var STR_CONTROLS_PLAY_13 = "Restart a clip (can also be used in case it freezes): Open information panel, navigate using use Directional pad (left/right) to \"Restart the Clip\" and press select";
