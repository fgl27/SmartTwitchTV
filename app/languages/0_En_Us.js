...
var STR_CONTROLS_PLAY_5 = "Change video quality (not availably for clips): Open information panel, , navigate using use Directional pad (left/right), then use Directional pad (up/down) to choose the new quality after press Select key to confirm the change";
var STR_CONTROLS_PLAY_6 = "Force refresh a video (in case it freezes) (not availably for clips): press select key twice, it will change the video quality to the same you are current watching, by opening information panel (first click) after second click will start re-buffering";
...
var STR_CONTROLS_PLAY_12 = "Change the speed (Only availably for clips): Open information panel, navigate using use Directional pad (left/right), then use Directional pad (up/down) to choose the new speed after press Select key to confirm the change";
var STR_CONTROLS_PLAY_13 = "Restart a clip (can also be used in case it freezes): color button blue or D";
var STR_CONTROLS_PLAY_14 = "Start a search: Open information panel, navigate using use Directional pad (left/right) to \"Search\" and press select";
var STR_CONTROLS_PLAY_15 = "Open Channel content: Open information panel, navigate using use Directional pad (left/right) to \"Channel content\" and press select";
...
var STR_CLIP_TO_VOD = "Open the broadcast at this clip position";
...
var STR_NO_VOD = "This clip doesn\'t have a ";
var STR_OPEN_BROADCAST = "Open Broadcast";
