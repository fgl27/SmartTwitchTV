...
function ru_RULang() {
    ...
    STR_LIVE_FEED_SORT_SUMMARY = "Сортировка боковой панели прямых трансляций и превью плеера. Применяется к отслеживаемым каналам в эфире, ретрансляциям (кто ретранслирует) и избранным (все остальное)";
    STR_A_Z = "Алфавит A - Z";
    STR_Z_A = "Алфавит Z - A";
