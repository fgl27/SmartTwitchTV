...
function ru_RULang() {
    ...
    STR_NOW_BACKGROUND_SUMMARY =
        'Если на вашем устройстве установлена версия Android 11 или новее, приложение будет отображать простое уведомление при работе в фоновом режиме. Когда приложение открыто, уведомление будет настраиваемым.';
