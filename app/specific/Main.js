...
var Main_stringVersion_Min = '.280';
var Main_version_java = 280;//Always update (+1 to current value) Main_version_java after update Main_stringVersion_Min or a major update of the apk is released
var Main_minversion = 'November 05 2020';
var Main_version_web = 530;//Always update (+1 to current value) Main_version_web after update Main_minversion or a major update of the web part of the app
...
function Main_Changelog() {
    ...
    var changelogObj = [
        {
            title: "Apk Version 3.0.280 - Web Version November 05 2020",
            changes: [
