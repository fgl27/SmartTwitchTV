...
SChannelContent.loadingDataTry = 1;
...
SChannelContent.init = function() {
    ...
    if (SChannelContent.status) SChannelContent.ScrollHelper.scrollVerticalToElementById(SChannelContent.Thumbnail + SChannelContent.cursorY + '_' + SChannelContent.cursorX);
...
SChannelContent.StartLoad = function() {
    ...
    SChannelContent.status = false;
    SChannelContent.skipImg = false;
    SChannelContent.ScrollHelper.scrollVerticalToElementById('blank_focus');
    Main.showLoadDialog();
...
SChannelContent.createCell = function(row_id, coloumn_id, channel_name, preview_thumbnail, stream_title, stream_game, channel_display_name, viwers, quality) {
    ...
    return $('<td id="' + SChannelContent.Cell + row_id + '_' + coloumn_id + '" class="stream_cell" data-channelname="' + channel_name + '"></td>').html(
        '<img id="' + SChannelContent.Thumbnail + row_id + '_' + coloumn_id + '" class="stream_thumbnail" src="app/images/video.png"/> \
    ...
    $('#stream_table_search_channel_a').imagesLoaded()
        .always({
            ...
            if (!SChannelContent.status) {
                ...
                SChannelContent.ScrollHelper.scrollVerticalToElementById(SChannelContent.Thumbnail + SChannelContent.cursorY + '_' + SChannelContent.cursorX);
            }
