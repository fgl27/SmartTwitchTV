...
function Sidepannel_KeyEnterBase() {
    if (!Main_values.Sidepannel_Pos) {
        ...
        Main_showAboutDialog(Sidepannel_Callback, ScreenObj[ScreenObjKey].key_controls = Screens_handleKeyControls.bind(null, ScreenObjKey));
    else if (Main_values.Sidepannel_Pos === 12)
        Main_showControlsDialog(Sidepannel_Callback, ScreenObj[ScreenObjKey].key_controls = Screens_handleKeyControls.bind(null, ScreenObjKey));
